    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String nama_temp = tnama.getText().toString();
                String matkul_temp = tmatkul.getText().toString();

                if (pilih.equals("Ubah")) {
                    database.child("Mahasiswa").child(key).setValue(new ModelMahasiswa(nama_temp, matkul_temp)).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
